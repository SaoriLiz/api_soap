<?php 
    ...
    $arg_obs = $_POST['arg_obs'];//"IGNORAR ESTE REGISTRO, ES DE PRUEBA.";
    $arg_archivo =  $_POST['arg_archivo'];
	        ...
	        $param=array('arg_codseg'=>$arg_codseg, 'arg_pobcta' =>(string)$arg_pobcta,'arg_gpocta' =>(string)$arg_gpocta,'arg_folcta' =>(string)$arg_folcta,'arg_subcta' =>(string)$arg_subcta,'arg_alta' => $arg_alta,'arg_tipoaccion' =>$arg_tipoaccion,'arg_obs' => $arg_obs,'arg_archivo' => $arg_archivo);
